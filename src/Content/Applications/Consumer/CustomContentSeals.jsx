...
export default function CustomContentSeals() {
  return (
    <>
      ...
      <TextImageRow
        sectionName={"rowOne"}
        imageName={"/images/pages/applications/consumer/seals/seals_prototype.png"}
      >
      ...
      <TextImageRow
        sectionName={"rowTwo"}
        imageRight={true}
        imageName={"/images/pages/applications/consumer/seals/seals_production_level.png"}
      >
      ...
      <TextImageRow
        ...
        imageName={"/images/pages/applications/consumer/seals/seals_materials.png"}
      >
