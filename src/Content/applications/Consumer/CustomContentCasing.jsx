...
export default function CustomContentCasing() {
  return (
    <>
      ...
      <TextImageRow
        sectionName={"rowOne"}
        imageName={"/images/pages/applications/consumer/casing/casing_housing.png"}
      ...
      <TextImageRow
        sectionName={"rowTwo"}
        imageRight={true}
        imageName={"/images/pages/applications/consumer/casing/casing_controller.png"}
      >
      ...
      <TextImageRow
        ...
        imageName={"/images/pages/applications/consumer/casing/casing_finishing.png"}
      >
