      ...
      >
        ...
        >
          <div style={styles.collapsePanel}>
            <div
              className="collapsedDropdownOption"
              style={styles.collapsedDropdownOption}
            >
            ...
            >
              ...
              <ul style={styles.optionList}>
                <li style={styles.optionListItem}>
                  <Link to="" style={styles.navlink}>
                    Vaciado con silicona y uretano
                  </Link>
                </li>
              </ul>
            </div>
        ...
        >
          <div style={styles.collapsePanel}>
            ...
            >
              ...
              <ul style={styles.optionList}>
                <li style={styles.optionListItem}>
                  <Link to="/productos/impresoras" style={styles.navlink}>
                    Impresoras
                  </Link>
                </li>
                <li style={styles.optionListItem}>
                  <Link to="/productos/materiales" style={styles.navlink}>
                    Materiales
                  </Link>
                </li>
              </ul>
        ...
        >
          <div style={styles.collapsePanel}>
            ...
            >
              ...
              <ul style={styles.optionList}>
                <li style={styles.optionListItem}>
                  <Link to="/industrias/fundicion" style={styles.navlink}>
                    Moldes de arena
                  </Link>
                </li>
              </ul>
            ...
            >
              ...
              <ul style={styles.optionList}>
                <li style={styles.optionListItem}>
                  <Link to="/industrias/joyeria" style={styles.navlink}>
            ...
            >
              ...
              <ul style={styles.optionList}>
                <li style={styles.optionListItem}>
                  <Link to="" style={styles.navlink}>
                    Desarrollo de polvos metálicos
                  </Link>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              <ul style={styles.optionList}>
                <li style={styles.optionListItem}>
                  <Link to="/salud/medicina" style={styles.navlink}>
                    Ortesis
                  </Link>
                </li>
                <li style={styles.optionListItem}>
